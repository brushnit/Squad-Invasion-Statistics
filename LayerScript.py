...
json_file_path = 'DBLog_Games_2023_10_08.json'
...
class Game:
    def __init__(self, game):
        ...
        self.V4 = game['id'] < 933
        self.V5 = 933 < game['id'] < 4710 
        self.V6 = game['id'] >= 4710 #only useful for sept data set, or combined data set
    ...
    with open(json_file_path, 'r') as json_file:
        ...
        for index, row in df.iterrows():
            ...
            for match in matches['DBLog_Games']:
                ...
                if game.layer == row['layer'] and game.isLiveMatch:
